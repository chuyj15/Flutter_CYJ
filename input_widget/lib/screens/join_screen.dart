                ...
                Column(
                  children: [
                      ...
                      TextField(
                        ...
                        textAlign: TextAlign.center, //숫자 가운데로 오게하기
                        controller: _countController,
                        keyboardType: TextInputType.number, //숫자만들어가게하기
                        inputFormatters: [ //숫자만들어가게하기
                        ...
                        onChanged: (value) {
                          ...
                          // int.tryparse(문자열) : 문자열같이 변환이 안되는 경우엔 null을 반환
                          // int newValue = int.tryParse(value) ?? _minCount;
                          
                          int newValue = int.tryParse(value) ?? -1; //빈 값일 때
